    ...
    public function run()
    {
        \DB::table('products')->insert([
            [
                ...
                'image4' => '',
                'category_id' => '9',
                'routeName' => 'electric_scooter.show',
                'sub_category_id' => null,
                'status' => '0'
            ],[
                'name' => 'iLark',
