                            ...
                            <div class="product-slider-container product-item">
                                <div class="product-single-carousel owl-carousel owl-theme">
                                    <div class="product-item">
                                        <img class="product-single-image" src="{{asset('assets/images/abouelgoukh/car_holders/'.$product->image)}}" data-zoom-image="{{asset('assets/images/abouelgoukh/bicycles/'.$product->image)}}"/>
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image" src="{{asset('assets/images/abouelgoukh/car_holders/'.$product->image)}}" data-zoom-image="{{asset('assets/images/abouelgoukh/bicycles/'.$product->image)}}"/>
                                    </div>
                                    ...
                                    <div class="product-default left-details product-widget">
                                        ...
                                        <div class="product-details">
                                            <h2 class="product-title">
                                                <a href="{{route('car_holders.show',$car_holder->id)}}">{{$carholder->name}}</a>
                                            </h2>
                                            ...
                                            <div class="price-box">
                                                <span class="product-price">{{$carholder->price}} EGP</span>
                                            </div><!-- End .price-box -->
